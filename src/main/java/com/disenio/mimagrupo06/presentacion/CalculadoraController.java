...
public class CalculadoraController {
  ...
  public ResponseEntity<String> calculadoraAnual() throws IOException {
    ...
    Template template = handlebars.compile("/Template/calculadoraHCAnualOrg");
  ...
  public ResponseEntity<String> calculadoraMensual() throws IOException {
    //validar accion en capa modelo según roles o usuario asociados al idSesion
    Template template = handlebars.compile("/Template/calculadoraHCMensualOrg");
  ...
  public ResponseEntity resultado() throws IOException {
      Template template = handlebars.compile("/Template/resultadoCalculadoraHC");
