...
public class Hogar extends Espacio{
  ...
  public Hogar(Double latitud, Double longitud, String direccion, String numero, float codigoPostal, String barrio, Integer piso, String departamento, TipoDeHogar tipoDeHogar) {
